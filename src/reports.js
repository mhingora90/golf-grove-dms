...
function buildReportsHub() {
  ...
  return [
    ...
    // Featured live report — Quality & Site
    '<div class="card" style="margin-bottom:14px;cursor:pointer;transition:box-shadow .15s"',
    ' onmouseover="this.style.boxShadow=\'0 4px 14px rgba(44,42,36,.10)\'"',
    ' onmouseout="this.style.boxShadow=\'0 1px 4px rgba(44,42,36,.05)\'"',
    ...
    '<div style="padding:12px 14px;border-bottom:0.5px solid var(--border);display:flex;justify-content:space-between;align-items:center">',
    '<div style="display:flex;align-items:center;gap:8px">',
    '<div style="width:22px;height:22px;border-radius:6px;background:var(--amber-bg);display:flex;align-items:center;justify-content:center;flex-shrink:0">',
    '<svg width="13" height="13" viewBox="0 0 18 18" fill="none"><path d="M3 9.5l3.5 3.5L15 5" stroke="#C97A1F" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"/></svg>',
    '</div>',
    '<span style="font-size:12px;font-weight:500;color:var(--charcoal)">Quality &amp; Site Report</span>',
    '<span class="badge badge-success" style="font-size:9px">Live</span>',
    '</div>',
    '<span style="font-size:11px;color:var(--text3)">Updated monthly</span>',
    '</div>',
    ...
    '<div>',
    '<div style="font-size:11px;color:var(--text2);line-height:1.6;max-width:520px;margin-bottom:10px">',
    'NCR open vs closed, inspection approval rates, punch list closure, RFI turnaround. Discipline breakdown, aging buckets, severity trend.',
    '</div>',
    '<div style="display:flex;gap:6px;flex-wrap:wrap">',
    _hubChip('Discipline breakdown'),
    _hubChip('Aging buckets'),
    _hubChip('Severity trend'),
    _hubChip('PDF export'),
    '</div>',
    '</div>',
    '<div style="display:flex;align-items:center;gap:5px;padding:7px 12px;background:var(--amber-bg);border:0.5px solid #F0D8A0;border-radius:8px;white-space:nowrap;font-size:11px;font-weight:500;color:var(--amber)">',
    'Open report',
    '<svg width="12" height="12" viewBox="0 0 14 14" fill="none"><path d="M3 7h8M8 4l3 3-3 3" stroke="#C97A1F" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/></svg>',
    '</div>',
    '</div>',
    '</div>',

    // Featured live report — Sales & CRM
    '<div class="card" style="margin-bottom:14px;cursor:pointer;transition:box-shadow .15s"',
    ' onmouseover="this.style.boxShadow=\'0 4px 14px rgba(44,42,36,.10)\'"',
    ' onmouseout="this.style.boxShadow=\'0 1px 4px rgba(44,42,36,.05)\'"',
    ' onclick="_openSalesReport()">',
    '<div style="padding:12px 14px;border-bottom:0.5px solid var(--border);display:flex;justify-content:space-between;align-items:center">',
    '<div style="display:flex;align-items:center;gap:8px">',
    '<div style="width:22px;height:22px;border-radius:6px;background:#E0EAF5;display:flex;align-items:center;justify-content:center;flex-shrink:0">',
    '<svg width="13" height="13" viewBox="0 0 18 18" fill="none"><path d="M3 14L7 9l3.5 3 4.5-7" stroke="#2B6CB0" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"/></svg>',
    '</div>',
    '<span style="font-size:12px;font-weight:500;color:var(--charcoal)">Sales &amp; CRM Report</span>',
    '<span class="badge badge-success" style="font-size:9px">Live</span>',
    '</div>',
    '<span style="font-size:11px;color:var(--text3)">Updated monthly</span>',
    '</div>',
    ...
    '<div>',
    '<div style="font-size:11px;color:var(--text2);line-height:1.6;max-width:520px;margin-bottom:10px">',
    'Lead pipeline funnel, conversion rates by stage, source breakdown, unit sale status, revenue booked, and 6-month leads-vs-sales trend.',
    '</div>',
    '<div style="display:flex;gap:6px;flex-wrap:wrap">',
    _hubChip('Pipeline funnel'),
    _hubChip('Source conversion'),
    _hubChip('Unit status'),
    _hubChip('PDF export'),
    '</div>',
    '</div>',
    '<div style="display:flex;align-items:center;gap:5px;padding:7px 12px;background:#E0EAF5;border:0.5px solid #B6CEE6;border-radius:8px;white-space:nowrap;font-size:11px;font-weight:500;color:#2B6CB0">',
    'Open report',
    '<svg width="12" height="12" viewBox="0 0 14 14" fill="none"><path d="M3 7h8M8 4l3 3-3 3" stroke="#2B6CB0" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/></svg>',
    '</div>',
    '</div>',
    '</div>',

    // Featured live report — Document Control
    '<div class="card" style="margin-bottom:14px;cursor:pointer;transition:box-shadow .15s"',
    ' onmouseover="this.style.boxShadow=\'0 4px 14px rgba(44,42,36,.10)\'"',
    ' onmouseout="this.style.boxShadow=\'0 1px 4px rgba(44,42,36,.05)\'"',
    ...
    '<div style="padding:12px 14px;border-bottom:0.5px solid var(--border);display:flex;justify-content:space-between;align-items:center">',
    '<div style="display:flex;align-items:center;gap:8px">',
    '<div style="width:22px;height:22px;border-radius:6px;background:#FFF8EC;display:flex;align-items:center;justify-content:center;flex-shrink:0">',
    '<svg width="13" height="13" viewBox="0 0 15 15" fill="none"><rect x="3" y="2" width="9" height="11" rx="1.5" stroke="#8B7E5E" stroke-width="1.3"/><path d="M5 5.5h5M5 8h3" stroke="#8B7E5E" stroke-width="1.1" stroke-linecap="round"/></svg>',
    '</div>',
    '<span style="font-size:12px;font-weight:500;color:var(--charcoal)">Document Control Report</span>',
    '<span class="badge badge-success" style="font-size:9px">Live</span>',
    '</div>',
    '<span style="font-size:11px;color:var(--text3)">Updated monthly</span>',
    '</div>',
    ...
    '<div>',
    '<div style="font-size:11px;color:var(--text2);line-height:1.6;max-width:520px;margin-bottom:10px">',
    'Drawing, submittal, RFI, NCR, inspection, and transmittal KPIs. Submittal funnel, open-items aging, discipline breakdown, and 6-month trend.',
    '</div>',
    '<div style="display:flex;gap:6px;flex-wrap:wrap">',
    _hubChip('Submittal funnel'),
    _hubChip('Open items aging'),
    _hubChip('Discipline breakdown'),
    _hubChip('PDF export'),
    '</div>',
    '</div>',
    '<div style="display:flex;align-items:center;gap:5px;padding:7px 12px;background:#FFF8EC;border:0.5px solid #E6D8B6;border-radius:8px;white-space:nowrap;font-size:11px;font-weight:500;color:#8B7E5E">',
    'Open report',
    '<svg width="12" height="12" viewBox="0 0 14 14" fill="none"><path d="M3 7h8M8 4l3 3-3 3" stroke="#8B7E5E" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/></svg>',
    '</div>',
    '</div>',
    '</div>',
  ].join('');
