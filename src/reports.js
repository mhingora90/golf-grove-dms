...
function buildReportsHub() {
  ...
  return [
    ...
    _hubLiveCard({
      ...
      iconBg: 'var(--green-bg)',
      iconSvg: '<svg width="13" height="13" viewBox="0 0 18 18" fill="none"><path d="M3 14V9M7 14V6M11 14V9M15 14V4" stroke="#3B6D11" stroke-width="1.6" stroke-linecap="round"/></svg>',
      desc: 'Cashflow, certified &amp; paid KPIs, contract breakdown, S-curve.',
      chips: ['Contracts','S-curve','PDF'],
    ...
    _hubLiveCard({
      ...
      iconBg: 'var(--amber-bg)',
      iconSvg: '<svg width="13" height="13" viewBox="0 0 18 18" fill="none"><path d="M3 9.5l3.5 3.5L15 5" stroke="#C97A1F" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"/></svg>',
      desc: 'NCRs, inspections, punch list, RFI turnaround. Aging &amp; severity.',
      chips: ['Aging','Severity','PDF'],
    ...
    _hubLiveCard({
      ...
      iconBg: '#E0EAF5',
      iconSvg: '<svg width="13" height="13" viewBox="0 0 18 18" fill="none"><path d="M3 14L7 9l3.5 3 4.5-7" stroke="#2B6CB0" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"/></svg>',
      desc: 'Lead pipeline, conversion, source breakdown, unit status, revenue.',
      chips: ['Pipeline','Unit status','PDF'],
      accentBg: '#E0EAF5',
      accentBorder: '#B6CEE6',
      accentColor: '#2B6CB0',
      arrowStroke: '#2B6CB0',
    ...
    _hubLiveCard({
      ...
      iconBg: '#FFF8EC',
      iconSvg: '<svg width="13" height="13" viewBox="0 0 15 15" fill="none"><rect x="3" y="2" width="9" height="11" rx="1.5" stroke="#8B7E5E" stroke-width="1.3"/><path d="M5 5.5h5M5 8h3" stroke="#8B7E5E" stroke-width="1.1" stroke-linecap="round"/></svg>',
      desc: 'Drawings, submittals, RFIs, NCRs. Funnel, aging, discipline.',
      chips: ['Funnel','Aging','PDF'],
      accentBg: '#FFF8EC',
      accentBorder: '#E6D8B6',
      accentColor: '#8B7E5E',
      arrowStroke: '#8B7E5E',
...
function _hubLiveCard(o) {
  return [
    '<div class="card" style="cursor:pointer;transition:box-shadow .15s;display:flex;flex-direction:column"',
    ' onmouseover="this.style.boxShadow=\'0 4px 14px rgba(44,42,36,.10)\'"',
    ' onmouseout="this.style.boxShadow=\'0 1px 4px rgba(44,42,36,.05)\'"',
    ' onclick="' + o.onclick + '">',
    '<div style="padding:10px 12px;border-bottom:0.5px solid var(--border);display:flex;align-items:center;gap:8px">',
    '<div style="width:22px;height:22px;border-radius:6px;background:' + o.iconBg + ';display:flex;align-items:center;justify-content:center;flex-shrink:0">',
    o.iconSvg,
    '</div>',
    '<span style="font-size:12px;font-weight:500;color:var(--charcoal);flex:1">' + o.title + '</span>',
    ...
    '<div style="font-size:11px;color:var(--text2);line-height:1.55;flex:1">' + o.desc + '</div>',
    '<div style="display:flex;flex-wrap:wrap;gap:5px">',
    o.chips.map(_hubChip).join(''),
    '</div>',
    '<div style="display:flex;align-items:center;justify-content:space-between;gap:8px;margin-top:2px">',
    '<span style="font-size:10px;color:var(--text3)">Updated monthly</span>',
    '<div style="display:inline-flex;align-items:center;gap:4px;padding:5px 10px;background:' + o.accentBg + ';border:0.5px solid ' + o.accentBorder + ';border-radius:6px;font-size:10px;font-weight:500;color:' + o.accentColor + '">',
    'Open',
    '<svg width="10" height="10" viewBox="0 0 14 14" fill="none"><path d="M3 7h8M8 4l3 3-3 3" stroke="' + o.arrowStroke + '" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/></svg>',
    '</div>',
    '</div>',
    '</div>',
    '</div>',
